function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/ca1/contents/dashboard/data/cellData',
            geneData: 'https://api.github.com/repos/acycliq/ca1/contents/dashboard/data/geneData',
            cellBoundaries: 'https://api.github.com/repos/acycliq/ca1/contents/dashboard/data/cellBoundaries',
