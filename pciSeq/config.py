...
DEFAULT = {
    ...
    "save_data": True,
    # Boolean. If True, compute and log the ELBO each iteration. Monitoring/debugging only,
    # it does not affect the result and it is expensive (several passes over the
    # nC x nG x nK tensor), so it is off by default.
    "compute_elbo": False,
