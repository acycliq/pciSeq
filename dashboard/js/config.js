function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_random_centroids/cellData?ref=master',
            geneData: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_random_centroids/geneData?ref=master',
            // cellCoords: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_cell_2279/cellCoords?ref=master',
            cellEllipsoid: 'https://api.github.com/repos/acycliq/data_dump/contents/ca1_random_centroids/cellEllipsoid?ref=master',
