    ...
    var ini = [
        {
            ...
            cellBoundaries: './dashboard/cell_coords_david.json',
            ...
            tiles: './dashboard/img/262144px/{z}/{y}/{x}.png',
            ...
            spot_json: function(d){ return './dashboard/img/json/David_full_brain/geneData_split/' + 'geneData_' + d + '.json'},
            cell_json: function(d){ return './dashboard/img/json/David_full_brain/cellData_split/' + 'cellData_' + d + '.json'},
